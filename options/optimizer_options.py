...
class OptimizerOptions:
    ...
    def __init__(self):
        self.parser = argparse.ArgumentParser(description='Options for StructuralOptimizer.')
        ...
        self.parser.add_argument('--initmode', dest='init_mode', type=str, default='uniform', help='Initial deformation rules')
        ...
        self.parser.add_argument('--laplsmoothlossperc', dest='laplsmooth_loss_perc', type=float, default=-1, help='laplacian smoothing percentual weight w.r.t. structural loss')
        self.parser.add_argument('--normconslossperc', dest='normcons_loss_perc', type=float, default=-1, help='normal consistency percentual weight w.r.t. structural loss')
        self.parser.add_argument('--varfaceareaslossperc', dest='varfaceareas_loss_perc', type=float, default=-1, help='face area variance percentual weight w.r.t. structural loss')
