...
import pandas as pd
import torch
from StructuralOptimizer import StructuralOptimizer
...
class WandbLogger:
    ...
    def make_run(self, row):
        ...
        optimizer = StructuralOptimizer(source_path, lr, momentum, self.device, init_mode, beam_have_load, loss_type, with_laplacian_smooth, with_normal_consistency, with_var_face_areas, laplsmooth_loss_perc, normcons_loss_perc, varfaceareas_loss_perc, boundary_reg)
